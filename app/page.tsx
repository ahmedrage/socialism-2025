...
const SOCIAL_LINKS = [
  {
    href: 'https://www.facebook.com/SocialistAlternativeAdelaide/',
    label: 'Facebook',
    Icon: FacebookIcon,
  },
  {
    href: 'https://www.instagram.com/socialist.alternative.adelaide/',
    label: 'Instagram',
    Icon: InstagramIcon,
  },
  {
    href: 'https://www.tiktok.com/@socialistalternativeadl',
    label: 'TikTok',
    Icon: TikTokIcon,
  },
];
...
export default async function HomePage() {
  ...
  const isReleased = data?.value === true;
